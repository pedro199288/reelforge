...
- **Modo semantic**: usa el guión + captions (Whisper) para clasificar silencios como *inter-oración* (cortar) o *intra-oración* (pausa natural, conservar). Decide **dónde** cortar, pero no **qué toma elegir**.
